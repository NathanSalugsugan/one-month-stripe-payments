...
growth_hacking = Product.create(title: "Growth Hacking", length: "30 minutes", 
    author_image_name: "teacher-image.jpg", 
	subtitle: "Crash Course", author: "Mattan Griffel", price: "4.99", 
    sku: "GROHACK1", download_url: "https://s3-ap-southeast-1.amazonaws.com/nathan-stripe-payments/CREDENTIAL.pdf", details: "You'll get one video", description: %{<p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
...
growth_hacking_monthly = Product.create(title: "Growth Hacking Monthly", length: "6 months", 
    author_image_name: "teacher-image.jpg", 
    subtitle: "Ongoing Course", author: "Mattan Griffel", price: "4.99", 
    sku: "GROHACK2", download_url: "https://s3-ap-southeast-1.amazonaws.com/nathan-stripe-payments/CREDENTIAL.pdf", details: "We'll charge you monthly for unlimited access to our mentoring team", description: %{<p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
